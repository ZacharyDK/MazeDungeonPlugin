#undef MAZEDUNGEONGENERATORPLUGIN_API
...
#define UE_PROJECT_NAME MazeDungeonSamp
#define UE_TARGET_NAME MazeDungeonSampEditor
...
#define MAZEDUNGEONGENERATORPLUGIN_API DLLEXPORT
